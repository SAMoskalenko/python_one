...
pattern_1 = '[А-Я][а-я]+ [А-Я][а-я]+$'

if re.match(pattern_1, name) is None:
    print('Имя введено неправильно!')

pattern_2 = '[a-z_0-9]+@[a-zA-Z1-9]+\.[ru|org|com]$'
if re.match(pattern_2, email) is None:
    print('Электронная почта введена неправильно!')
...
if re.search(pattern, some_str) is None:
    print('В тексте нет повторяющихся подряд точек')
else:
    print('В тексте есть повторяющиеся точки')
